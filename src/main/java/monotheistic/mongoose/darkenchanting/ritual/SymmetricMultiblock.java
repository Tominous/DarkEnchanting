...
abstract class SymmetricMultiblock {
    ...
    public SymmetricMultiblock(Material[][][] layout, Material trigger, Predicate<ItemStack> triggerItem, Triple<Integer, Integer, Integer> triggerPos, Consumer<PlayerInteractEvent> onClick) {
        this.layout = layout;
    ...
    public SymmetricMultiblock(Material[][][] layout, Material trigger, Predicate<ItemStack> triggerItem, Triple<Integer, Integer, Integer> triggerPos) {
        this(layout, trigger, triggerItem, triggerPos, null);
    }

    public void setAction(Consumer<PlayerInteractEvent> action) {
        this.eventConsumer = action;
    }

    public boolean check(Block clickedBlock, ItemStack clickedWith) {
